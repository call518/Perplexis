    ...
    with st.sidebar:
        ...
        with col_ai_llm:
            if st.session_state['selected_ai'] == "OpenAI":
                ...
                st.session_state['selected_llm'] = st.selectbox("AI LLM", ["gemma2:2b", "gemma2:9b", "gemma2:27b", "mistral", "llama3.2", "codegemma"], index=0, disabled=st.session_state['is_analyzed'])
